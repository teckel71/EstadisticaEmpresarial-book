...
::: {style="text-align: center;"}
[]{#tab:trabajadores-preview}**Tabla 2.1.** Primeras filas del fichero `trabajadores.xlsx`: cada fila es un individuo (empleado), cada columna una característica.
:::
...
::: {style="text-align: center;"}
[]{#tab:fuentes-comparacion}**Tabla 2.2.** Fuentes primarias frente a fuentes secundarias: ventajas e inconvenientes.
:::
...
::: {style="text-align: center;"}
[]{#tab:formatos-tabla}**Tabla 2.3.** Formatos habituales de intercambio de datos.
:::
...
::: {style="text-align: center;"}
[]{#fig:wald-bombardero}**Figura 2.2**
:::
...
::: {style="text-align: center;"}
[]{#tab:muestreos-tabla}**Tabla 2.4.** Principales tipos de muestreo, familia a la que pertenecen y uso recomendado.
:::
...
::: {style="text-align: center;"}
[]{#fig:tamano-muestra-fig}**Figura 2.3**
:::
...
::: {style="text-align: center;"}
[]{#tab:bd-comparacion}**Tabla 2.5.** Bases de datos relacionales frente a NoSQL: comparación resumida.
:::
...
::: {style="text-align: center;"}
[]{#tab:diccionario-astilleros}**Tabla 2.6.** Diccionario de datos del fichero `astilleros_48.xlsx` (hoja *Variables*).
:::
...
::: {style="text-align: center;"}
[]{#tab:missing-simulacion}**Tabla 2.7.** Extracto de un fichero recibido de RR.HH.: los huecos se han codificado como cadena vacía, como texto `n.d.` y como `999`. Todos son en realidad valores perdidos.
:::
...
::: {style="text-align: center;"}
[]{#tab:missing-tabla}**Tabla 2.8.** Estrategias para el tratamiento de valores perdidos, con sus ventajas, inconvenientes y usos típicos.
:::
...
::: {style="text-align: center;"}
[]{#fig:outliers-astilleros}**Figura 2.4**
:::
