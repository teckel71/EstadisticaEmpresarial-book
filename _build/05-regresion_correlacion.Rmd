...
::: {style="text-align: center;"}
[]{#tab:astilleros-tabla-reg}**Tabla 5.1.** Tabla de correlación de antigüedad ($X$) y tonelaje ($Y$) con las columnas y filas auxiliares para el cálculo directo de los momentos.
:::
...
::: {style="text-align: center;"}
[]{#fig:astilleros-scatter-reg}**Figura 5.2.** Diagrama de dispersión de la flota y recta ajustada por mínimos cuadrados.
:::
...
::: {style="text-align: center;"}
[]{#tab:astilleros-tipo1}**Tabla 5.2.** Regresión de tipo I sobre la flota: medias condicionadas del tonelaje para cada intervalo de antigüedad.
:::
...
::: {style="text-align: center;"}
[]{#fig:astilleros-tipo1-tipo2}**Figura 5.3.** Regresión de tipo I (puntos oscuros: medias condicionadas del tonelaje por intervalo de antigüedad, con tamaño proporcional a la frecuencia) frente a regresión de tipo II (recta mínimo-cuadrática) sobre la flota.
:::
...
```{r outlier-demo, fig.width=7.5, fig.height=3.8}
set.seed(42)
n_norm <- 30
...
::: {style="text-align: center;"}
[]{#fig:outlier-demo}**Figura 5.4.** Efecto de un único valor atípico sobre la recta de regresión. Comparen la línea negra continua (con el atípico) con la discontinua ámbar (sin él): el ajuste cambia sustancialmente y el $R^{2}$ se hunde.
:::
...
::: {style="text-align: center;"}
[]{#fig:astilleros-residuos}**Figura 5.5.** Residuos frente a valores ajustados en la flota, por astillero. La estructura del color muestra que la antigüedad, por sí sola, no capta la segmentación por constructor.
:::
...
::: {style="text-align: center;"}
**Tabla 5.3.** Escala orientativa para $|R|$ en el análisis descriptivo.
:::
...
```{r dos-rectas-plot, fig.width=6.5, fig.height=4}
...
::: {style="text-align: center;"}
[]{#fig:dos-rectas-plot}**Figura 5.6.** Las dos rectas de regresión sobre la flota. Se cruzan en el centro de gravedad $(\overline{x},\ \overline{y})$ y su apertura mide indirectamente la dispersión de la nube.
:::
...
::: {style="text-align: center;"}
[]{#fig:rstars-ing-costop-scatter}**Figura 5.7.** Nube de puntos y recta de regresión sobre las 300 compañías de la muestra R-Stars.
:::
...
```{r anscombe, fig.width=7.5, fig.height=5.5}
df_a <- tibble(
...
::: {style="text-align: center;"}
[]{#fig:anscombe}**Figura 5.8.** El cuarteto de Anscombe. Los cuatro conjuntos comparten media, varianza, covarianza, coeficientes de la recta ajustada y $R^{2}$ hasta la segunda cifra decimal. Solo el conjunto (I) responde a un ajuste lineal genuino.
:::
...
::: {style="text-align: center;"}
[]{#tab:curva-aprendizaje-datos}**Tabla 5.4.** Curva de aprendizaje de un tripulante en el módulo de revisión de motores de Hyperdrive Express.
:::
...
::: {style="text-align: center;"}
[]{#fig:curva-scatter}**Figura 5.9.** Datos de la tabla anterior con dos ajustes: lineal (gris, discontinuo) y potencial (negro, continuo).
:::
