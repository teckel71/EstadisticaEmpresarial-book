...
::: {style="text-align: center;"}
**Figura 8.6.** Anatomía de una variable aleatoria continua: la esperanza $\\mu$ señala el centro; la desviación típica $\\sigma$, cómo de ancha es la distribución. El área sombreada cubre el intervalo $[\\mu - \\sigma,\\ \\mu + \\sigma]$.
:::
