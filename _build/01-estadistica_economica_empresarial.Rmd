...
::: {style="text-align: center;"}
**Tabla 1.1.** Primeros casos del fichero de empleados de Bebop Stellar Cargo.
:::
...
::: {style="text-align: center;"}
**Tabla 1.3.** Distribución de frecuencias del salario en Bebop Stellar Cargo (cientos de PAVOs).
:::
