...
## Un ejemplo de referencia: *Bebop Stellar Cargo*. {#ejemplo-empresa}

Para ilustrar de forma uniforme los conceptos que siguen, utilizaremos un ejemplo extraído del universo R-Stars: la plantilla de **Bebop Stellar Cargo, S.G.**, una compañía de tamaño medio especializada en el transporte de mercancías entre el cinturón de asteroides y las lunas heladas de Júpiter, con sede en **Ganímedes**. La empresa fue fundada por un grupo de pilotos veteranos cansados de cobrar a destajo, y hoy la dirige *Faye Tachyeres*, antigua cazarrecompensas reconvertida —según ella misma admite, con cierta resignación— en directora financiera.
...
empresa |>
  ...
  kable(caption = "Primeros casos del fichero de empleados de Bebop Stellar Cargo.",
        align = "c") |>
...
frec_salario |>
  kable(caption = "Distribución de frecuencias del salario en Bebop Stellar Cargo (cientos de PAVOs).",
...
ggplot(empresa, aes(salario)) +
  ...
  labs(title    = "Distribución del salario mensual",
       subtitle = "Bebop Stellar Cargo. Intervalos de igual amplitud",
...
Cuando los datos están más concentrados en una zona, suele convenir usar intervalos más estrechos allí y más anchos en las colas. Para ilustrarlo, trabajaremos con una segunda muestra: el **importe anual de los contratos** (en miles de PAVOs) firmados con los 200 mayores clientes corporativos de Bebop Stellar Cargo a lo largo del último ejercicio.
...
A partir de aquí, en el siguiente capítulo profundizaremos en cómo **resumir** una variable estadística unidimensional mediante medidas de posición, dispersión, forma y concentración. *Bebop Stellar Cargo* nos seguirá acompañando.
