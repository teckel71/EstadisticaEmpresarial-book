...
![Cuando la información se cruza: dos variables, una historia.](figuras/03_astronautas.jpg){.portada-img width="100%"}
...
tabla_cond_yx %>%
  kable(caption = "Distribución del nivel de estudios condicionada al tramo salarial (cada fila suma 1).",
        col.names = c("Salario", "$Y=$ Básicos", "$Y=$ Medios",
                      "$Y=$ Universitarios"),
        digits    = 4,
        align     = "c",
...
tabla_esp_rs %>%
  kable(caption = "Frecuencias observadas y esperadas bajo independencia para el cruce FJUR × EFLO.",
        col.names = c("FJUR",
...
tabla_show %>%
  kable(caption = "Astillero constructor × sede base (fragmento representativo). Cada astillero opera desde un conjunto disjunto de sedes.",
        align     = "c",
        row.names = FALSE,
        escape    = FALSE) %>%
  kable_styling(bootstrap_options = c("hover", "condensed"),
