...
::: {style="text-align: center;"}
[]{#tab:shuttlepod-head}**Tabla 4.2.** Primeros casos del fichero de empleados de Shuttlepod Movers.
:::
...
::: {style="text-align: center;"}
[]{#tab:shuttlepod-tabla-abs}**Tabla 4.3.** Salario ($X$) y nivel de estudios ($Y$) en la plantilla de Shuttlepod Movers. Frecuencias absolutas conjuntas y marginales.
:::
...
::: {style="text-align: center;"}
[]{#tab:shuttlepod-tabla-rel}**Tabla 4.4.** Frecuencias relativas conjuntas y marginales en Shuttlepod Movers.
:::
...
::: {style="text-align: center;"}
[]{#tab:shuttlepod-tabla-cond}**Tabla 4.5.** Distribución del salario condicionada al nivel de estudios (cada columna suma 1).
:::
...
::: {style="text-align: center;"}
[]{#tab:shuttlepod-tabla-cond-yx}**Tabla 4.6.** Distribución del nivel de estudios condicionada al tramo salarial (cada fila suma 1).
:::
...
::: {style="text-align: center;"}
[]{#fig:shuttlepod-condicionadas-barras}**Figura 4.2**
:::
...
::: {style="text-align: center;"}
[]{#tab:ejemplo-indep-abs}**Tabla 4.7.** Salario ($X$) y gasto mensual en la cantina corporativa ($Y$) en la plantilla combinada de Corellian Freightworks.
:::
...
::: {style="text-align: center;"}
[]{#tab:ejemplo-indep-cond}**Tabla 4.8.** Distribución del salario ($X$) condicionada al gasto en cantina ($Y$) en Corellian Freightworks. Todas las columnas son idénticas.
:::
...
::: {style="text-align: center;"}
[]{#tab:shuttlepod-esperadas}**Tabla 4.9.** Frecuencias observadas ($n_{ij}$) frente a esperadas bajo independencia ($n^{*}_{ij}$) en Shuttlepod Movers.
:::
...
::: {style="text-align: center;"}
[]{#tab:astilleros-tabla-abs}**Tabla 4.10.** Antigüedad ($X$, años) y tonelaje ($Y$, miles de toneladas) de los 48 cargueros. Frecuencias absolutas.
:::
...
::: {style="text-align: center;"}
[]{#fig:astilleros-scatter}**Figura 4.3**
:::
...
::: {style="text-align: center;"}
[]{#fig:cuarteto-covarianza}**Figura 4.4**
:::
...
::: {style="text-align: center;"}
[]{#tab:rstars-fjur-eflo-obs}**Tabla 4.11.** Forma jurídica y estado de la flota en las 300 compañías R-Stars. Frecuencias observadas.
:::
...
::: {style="text-align: center;"}
[]{#tab:rstars-esperadas}**Tabla 4.12.** Frecuencias observadas y esperadas bajo independencia para el cruce FJUR × EFLO.
:::
...
::: {style="text-align: center;"}
[]{#fig:shuttlepod-residuos}**Figura 4.5**
:::
...
::: {style="text-align: center;"}
[]{#tab:astill-sede-tabla}**Tabla 4.13.** Astillero constructor × sede base (fragmento representativo). Cada astillero opera desde un conjunto disjunto de sedes.
:::
