...
![](figuras/03_puente_cruce.jpg){.portada-img width="100%"}

::: {style="text-align: center;"}
**Figura 3.1.** [Cuando la información se cruza: dos variables, una historia.]{.smallcaps}
:::
...
::: {style="text-align: center;"}
**Tabla 3.2.** Salario ($X$) y nivel de estudios ($Y$) en la plantilla de Shuttlepod Movers. Frecuencias absolutas conjuntas y marginales.
:::
...
::: {style="text-align: center;"}
**Tabla 3.3.** Frecuencias relativas conjuntas y marginales en Shuttlepod Movers.
:::
...
::: {style="text-align: center;"}
**Tabla 3.4.** Distribución del salario condicionada al nivel de estudios (cada columna suma 1).
:::
...
::: {style="text-align: center;"}
**Tabla 3.5.** Salario ($X$) y gasto mensual en la cantina corporativa ($Y$) en la plantilla combinada de Corellian Freightworks.
:::
...
::: {style="text-align: center;"}
**Tabla 3.6.** Distribución del salario ($X$) condicionada al gasto en cantina ($Y$) en Corellian Freightworks. Todas las columnas son idénticas.
:::
...
::: {style="text-align: center;"}
**Tabla 3.7.** Frecuencias observadas ($n_{ij}$) frente a esperadas bajo independencia ($n^{*}_{ij}$) en Shuttlepod Movers.
:::
...
::: {style="text-align: center;"}
**Tabla 3.8.** Forma jurídica y estado de la flota en las 300 compañías R-Stars. Frecuencias observadas.
:::
...
::: {style="text-align: center;"}
**Tabla 3.9.** Frecuencias observadas y esperadas bajo independencia para FJUR $\\times$ EFLO.
:::
...
::: {style="text-align: center;"}
**Tabla 3.10.** Astillero constructor $\\times$ sede base (fragmento representativo). Cada astillero opera desde un conjunto disjunto de sedes.
:::
