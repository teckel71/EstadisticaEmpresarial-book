...
::: {style="text-align: center;"}
**Tabla 6.1.** Ruta Arrakis–Coruscant de Arrakis Freight, 2210–2213.
:::
...
::: {style="text-align: center;"}
**Tabla 6.2.** Índices simples de base fija (base = 2210) para la ruta Arrakis–Coruscant.
:::
...
::: {style="text-align: center;"}
**Tabla 6.3.** Índices simples encadenados para la ruta Arrakis–Coruscant.
:::
...
::: {style="text-align: center;"}
**Tabla 6.4.** Hyperdrive Express: precios y cantidades de dos servicios en 2210 (base) y 2213.
:::
...
::: {style="text-align: center;"}
**Tabla 6.5.** Índices complejos de Hyperdrive Express, del año 2210 al 2213 (base 2210 = 100).
:::
...
::: {style="text-align: center;"}
**Tabla 6.6.** Cambio de base de un índice de precios: enlace técnico de la base 2208 a la base 2212.
:::
...
::: {style="text-align: center;"}
**Tabla 6.7.** Producción de Isla Cinturón en el año 0. Los precios están en PAVOs y las cantidades en las unidades habituales de cada bien.
:::
...
::: {style="text-align: center;"}
**Tabla 6.8.** Producción de Isla Cinturón en el año t. Ninguno de los cuatro precios se ha mantenido estable respecto del año 0.
:::
...
::: {style="text-align: center;"}
**Tabla 6.9.** Producción del año t valorada a precios del año 0. Ahora sí se compara producción con producción.
:::
...
::: {style="text-align: center;"}
**Tabla 6.10.** Gasto en consumo final del Sistema Astolat: paso de nominal a real usando el IPGG como deflactor.
:::
