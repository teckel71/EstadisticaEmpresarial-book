...
```{r fig-indices-simples-cap06, fig.cap="Índices simples de precios, cantidades y valor de la ruta Arrakis–Coruscant (base 2210 = 100)."}
df_arrakis <- tibble(
  Anio  = 2210:2213,
...
```{r fig-deflactacion-cap06, fig.cap="Gasto en consumo final del Sistema Astolat: series nominal y real, con base 2210 = 100."}
df_defla <- tibble(
  Anio     = 2209:2214,
