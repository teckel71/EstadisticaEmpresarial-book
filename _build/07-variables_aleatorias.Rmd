...
::: {style="text-align: center;"}
**Figura 7.2.** Distribución empírica del número de cargueros por empresa en `interestelar_300`. Bajo el enfoque frecuentista, este histograma es una aproximación a la distribución de probabilidad de la variable aleatoria 'flota de una empresa cualquiera'.
:::
...
::: {style="text-align: center;"}
**Figura 7.3.** Función de cuantía (izquierda) y función de distribución (derecha) de $\\xi$: número de cargueros a tiempo en *arrakis freight*.
:::
...
::: {style="text-align: center;"}
**Figura 7.4.** Función de densidad del tiempo de descarga (horas) en la nueva grúa KORRIGAN. El área sombreada es $P(1 < \\xi < 2) = 3/16$.
:::
...
::: {style="text-align: center;"}
**Figura 7.5.** Anatomía de una variable aleatoria continua: la esperanza señala el centro; la desviación típica, cómo de ancha es la distribución.
:::
