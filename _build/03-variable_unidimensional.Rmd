...
**Los cuatro grandes bloques de medidas para una variable.**
...
**Cálculo de la media agrupada de los salarios de *Hyperdrive Express*.**
...
**Cuartiles del salario en *Hyperdrive Express*.**
...
**Distribución de frecuencias del salario incluyendo a la CEO (\(N = 61\)).**
...
**Diagramas de caja del salario en *Hyperdrive Express*.** A la izquierda, la plantilla de 60 empleados; a la derecha, incluyendo a la CEO. La caja apenas se mueve; el bigote se estira ligeramente; pero el *outlier* que aparece en solitario en el segundo gráfico es toda la información visual que necesitábamos.
...
**Momentos respecto al origen del salario en *Hyperdrive Express*.**
...
ggplot(df_disp, aes(x = salario, fill = grupo)) +
  ...
  labs(x = "Salario (cientos de PAVOs)", y = "Nº de empleados") +
...
**Dos plantillas con la misma media (17,20 cientos de PAVOs, línea roja discontinua) y distinta dispersión.** En la de la derecha, la media describe con precisión lo que le ocurre a cada empleado. En la de la izquierda, la media es solo una referencia: muchos casos están lejos de ese valor, y ninguna decisión razonable sobre política salarial debería basarse solo en él.
...
**Información y varianza.** La variable A no permite distinguir empresas entre sí; la B las distingue con cierta dificultad; la C las diferencia con claridad.
...
**Comparación salarial de dos compañías R-Stars.**
...
**Tipos de asimetría en distribuciones unimodales campaniformes.** En azul, la distribución observada; en trazo naranja discontinuo, la distribución normal "equivalente" (misma media y misma desviación típica) que sirve de referencia. La asimétrica positiva tiene la cola larga hacia la derecha; la negativa, hacia la izquierda.
...
**Tipos de apuntamiento o curtosis en distribuciones unimodales campaniformes.** En verde, la distribución observada; en trazo naranja discontinuo, la distribución normal "equivalente" (misma media y misma desviación típica) que sirve de referencia. La platicúrtica tiene el pico más aplanado y las colas más ligeras que la normal; la leptocúrtica, el pico más alto y las colas más pesadas.
...
- **Dispersión** (varianza, desviación típica, CV): cuán representativa es la posición central. La varianza mide, además, la **cantidad de información** que la variable aporta sobre los casos. El CV tiene la ventaja añadida de ser **adimensional**, y permite comparaciones entre distribuciones de escala distinta. La estandarización (z-scores) traduce cualquier valor a "cuántas desviaciones típicas se aparta de la media", cimiento de la regla empírica 68–95–99,7.
- **Forma** (asimetría y curtosis de Fisher): la forma del histograma respecto al patrón campaniforme simétrico. Los ejemplos R-Stars nos han enseñado a leer estas medidas en clave económica: distribuciones de tamaño con cola larga, márgenes competitivos que gravitan hacia la simetría, rentabilidades con riesgo de cola.
