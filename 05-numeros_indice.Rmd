...
arrakis %>%
  ...
  kable(
    caption   = "Ruta Arrakis–Coruscant de Arrakis Freight, 2210–2213.",
    align     = "cccc",
    booktabs  = TRUE
  ) %>%
  kable_styling(
...
arr_idx_bf %>%
  ...
  kable(
    caption   = "Índices simples de base fija (base = 2210) para la ruta Arrakis–Coruscant.",
    align     = "cccc",
    booktabs  = TRUE,
    escape    = FALSE
  ) %>%
...
hyper %>%
  ...
  kable(
    caption  = "Hyperdrive Express: precios y cantidades de dos servicios en 2210 (base) y 2213.",
    align    = "ccccc",
    booktabs = TRUE,
    escape   = FALSE
  ) %>%
...
tibble(
  ...
  kable(
    caption   = "Índices complejos de Hyperdrive Express, del año 2210 al 2213 (base 2210 = 100).",
    align     = "lcc",
    booktabs  = TRUE,
    escape    = FALSE
  ) %>%
...
cambio_base %>%
  ...
  kable(
    caption   = "Cambio de base de un índice de precios: enlace técnico de la base 2208 a la base 2212.",
    align     = "cccc",
    booktabs  = TRUE,
    escape    = FALSE
  ) %>%
