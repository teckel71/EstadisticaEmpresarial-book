...
tab_bayes |>
  kable(
    caption   = "Cuota de producción y probabilidad de sufrir un fallo grave durante el primer año de servicio, por astillero. Fuente: Consejo Estelar de Ingeniería (datos ad hoc con fines ilustrativos, coherentes con la fiabilidad histórica de la flota real).",
    align     = c("l","c","c"),
    booktabs  = TRUE,
    escape    = FALSE,
